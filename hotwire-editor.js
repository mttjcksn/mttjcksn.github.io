...
["___indirect_function_table","_isFirefox","_isSafari","_getContextSampleRate","___set_stack_limits","onRuntimeInitialized"].forEach((prop) => {
...
// end include: preamble.js
  ...
  var _emscripten_start_wasm_audio_worklet_thread_async = (contextHandle, stackLowestAddress, stackSize, callback, userData) => {
      ...
      audioWorklet.addModule('hotwire-editor.aw.js').then(() => {
...
globalThis.AudioWorkletModule = hwm;
